...
vector<pair<string, double> > VectorSpaceModel::GetRankingResult(vector<pair<string,string> >& query, vector<string>& possible_DocIDs){
vector<string> terms; // merge duplicate terms
	vector<double> query_tfidf;
	vector<double> idfs;
	unordered_map<string, vector<double> > doc_tfidf;
...
vector<pair<string, double>> VectorSpaceModel::GetOriginalRankingResult(vector<pair<string,string> >& query){
	vector<string> terms; // merge duplicate terms
	vector<double> query_tfidf;
	vector<double> idfs;
	unordered_map<string, vector<double> > doc_tfidf;
